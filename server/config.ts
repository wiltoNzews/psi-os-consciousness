...
export const SYSTEM_QUANTUM_STATE: QuantumState = getDefaultQuantumState(NODE_ENV);
...
export const REALITY_MODE: boolean = SYSTEM_QUANTUM_STATE.toString().startsWith('REAL_');
...
export const LOG_LEVEL = process.env.LOG_LEVEL ? parseInt(process.env.LOG_LEVEL) : 3;

// Agent concurrency limits to prevent system overload
export const AGENT_CONCURRENCY_LIMITS = {
...
export const SIMULATION_REALITY_CONFIG = {
