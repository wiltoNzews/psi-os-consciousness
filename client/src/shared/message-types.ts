...
export enum QuantumMessageType {
  ...
  // Meta-cognitive API
  MetaCognitiveSubscribe = 'metacognitive_subscribe',
  MetaCognitiveSubscribed = 'metacognitive_subscribed',
  MetaCognitiveGetInsights = 'metacognitive_get_insights',
  MetaCognitiveInsightsResult = 'metacognitive_insights_result',
  MetaCognitiveInsightsUpdate = 'metacognitive_insights_update',
  MetaCognitiveGetPatterns = 'metacognitive_get_patterns',
  MetaCognitivePatternsResult = 'metacognitive_patterns_result',
  MetaCognitivePatternsUpdate = 'metacognitive_patterns_update',
  MetaCognitiveUpdateFilters = 'metacognitive_update_filters',
  MetaCognitiveGetStats = 'metacognitive_get_stats',
  MetaCognitiveStatsResult = 'metacognitive_stats_result',
  MetaCognitiveUnsubscribe = 'metacognitive_unsubscribe',
  MetaCognitiveError = 'metacognitive_error'
}
