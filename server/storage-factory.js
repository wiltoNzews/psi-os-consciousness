...
(function (StorageType) {
    StorageType["FILE_SYSTEM"] = "file_system";
...
export function createStorage(type) {
    return __awaiter(this, void 0, void 0, function () {
        var dbAvailable, _a, dbAvailable;
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (dbAvailable) {
                        ...
                        return [2 /*return*/, new PostgreSQLStorage()];
                    }
                    else {
                        console.log('⚠️ PostgreSQL connection failed, falling back to file system storage');
                        return [2 /*return*/, new FileSystemStorage()];
                    }
                    _b.label = 2;
                case 2:
                    _a = type;
                    switch (_a) {
                        case StorageType.POSTGRESQL: return [3 /*break*/, 3];
                        case StorageType.FILE_SYSTEM: return [3 /*break*/, 5];
                        case StorageType.MEMORY: return [3 /*break*/, 6];
                    }
                    return [3 /*break*/, 7];
                case 3: return [4 /*yield*/, testConnection()];
                case 4:
                    dbAvailable = _b.sent();
                    if (!dbAvailable) {
