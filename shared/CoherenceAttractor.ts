...
export class CoherenceAttractor extends EventEmitter {
  ...
  private static readonly DEFAULT_ATTRACTOR_STRENGTH = 0.9;
  private static readonly DEFAULT_MAX_DEVIATION = 0.15;
  private static readonly DEFAULT_CYCLE_INTERVAL = 15000; // 15 seconds
  private static readonly DEFAULT_STABILITY_DURATION = 12; // cycles
  private static readonly DEFAULT_ADAPTABILITY_DURATION = 4; // cycles
  
  private targetCoherence: number;
  private attractorStrength: number;
  private maxDeviation: number;
  private cycleInterval: number;
  private stabilityPhaseDuration: number;
  private adaptabilityPhaseDuration: number;
  
  private currentCoherence: number;
  private previousCoherence: number;
  private currentPhase: CoherencePhase;
  private cycleCount: number = 0;
  private phaseCounter: number = 0;
  private isRunning: boolean = false;
  private timer: NodeJS.Timeout | null = null;
  private isPerturbed: boolean = false;
  private perturbationTarget: number | null = null;
  private perturbationDuration: number = 0;
  private perturbationCounter: number = 0;
   ...
   */
  private calculateNextCoherence(): number {
   ...
   */
  private handlePerturbation(): void {
    if (!this.isPerturbed || this.perturbationTarget === null) {
      return;
    }
   ...
   */
  public getPhase(): CoherencePhase {
   ...
   */
  public updateParameters(params: Partial<CoherenceAttractorParams>): void {
