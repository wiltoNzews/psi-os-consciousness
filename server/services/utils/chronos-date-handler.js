...
export var ChronosDateHandler = {
     ...
     */
    transformDates: function (obj, direction) {
        var _this = this;
        ...
        if (Array.isArray(obj)) {
            return obj.map(function (item) { return _this.transformDates(item, direction); });
        }
        // Handle objects
        if (typeof obj === 'object') {
            ...
            Object.keys(obj).forEach(function (key) {
                ...
                if (obj[key] === '[Circular Reference]') {
                    ...
                    result_1[key] = _this.transformDates(obj[key], direction);
                }
            });
            return result_1;
        }
