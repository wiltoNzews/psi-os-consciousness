...
export var fileStorage = new FileSystemStorage('./data');
...
export var storage = process.env.NODE_ENV === 'production'
    ? fileStorage
    : memStorage;
// Make sure the console log matches our actual implementation logic
console.log("Using ".concat(process.env.NODE_ENV === 'production' ? 'FileSystemStorage' : 'MemStorage', " for primary storage"));
...
export var persistentContextService = new MemPersistentContextService();
